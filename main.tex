...
\begin{fact*}
Let $k$ be field, and let $A$ be a commutative $k$-algebra of finite dimension $n$ over $k$. If the form $\gen{x,y} = \trace m_{xy}$ is non-degenerate, then $A$ has no non-zero nilpotents.
\end{fact*}
